...
/**
 * MemberData-Forms activation routines
 *
...
function memberdataforms_uninstall_hook()
{
    Activator::uninstall();
}
...
class Activator
{
    private const CONFIG = MEMBERDATAFORMS_PACKAGENAME . "_version";
    ...
    public static function uninstall()
    {
        ...
        $model = new Migration(MEMBERDATAFORMS_PACKAGENAME . '_migrations');
    ...
    public static function register($plugin)
    {
        ...
        register_uninstall_hook($plugin, "memberdataforms_uninstall_hook");
