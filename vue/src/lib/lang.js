...
export default {
    ...
    MSGRULELT: __('%s must be smaller than %f', 'memberdata-forms'),
    MSGRULELTE: __('%s must be smaller than or equal to %f', 'memberdata-forms'),
    MSGRULEGTE: __('%s must be greater than or equal to %f', 'memberdata-forms'),
    MSGRULEGT: __('%s must be greater than %f', 'memberdata-forms'),
    MSGRULELTDATE: __('%s must be before %s', 'memberdata-forms'),
    MSGRULELTEDATE: __('%s must be before or at %s', 'memberdata-forms'),
    MSGRULEGTEDATE: __('%s must be at or after %s', 'memberdata-forms'),
    MSGRULEGTDATE: __('%s must be after %s', 'memberdata-forms'),
    MSGRULELTSTRING: __('%s must be smaller than %d characters', 'memberdata-forms'),
    MSGRULELTESTRING: __('%s must be smaller or equal to %d characters', 'memberdata-forms'),
    MSGRULEGTESTRING: __('%s must have at least %d characters', 'memberdata-forms'),
    MSGRULEGTSTRING: __('%s must have more than %d characters', 'memberdata-forms'),
    ...
    MSGRULEDATE: __('%s must be a valid date in the format %s', 'memberdata-forms'),
    MSGRULETIME: __('%s must be a valid time in the format %s', 'memberdata-forms'),
